...
var RLIB = /** @class */ (function () {
    function RLIB() {
        ...
        this.apiSite = 'https://api.mangalib.me/api/manga/';
        this.version = '2.1.2';
    ...
    RLIB.prototype.parseNovel = function (novelPath) {
        return __awaiter(this, void 0, void 0, function () {
            var data, novel, genres, branch_name, chaptersJSON, chapters_1;
            var _a, _b, _c, _d, _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)(this.apiSite +
                            novelPath +
                            '?fields[]=summary&fields[]=genres&fields[]=tags&fields[]=teams&fields[]=authors&fields[]=status_id&fields[]=artists', { headers: (_a = this.user) === null || _a === void 0 ? void 0 : _a.token }).then(function (res) { return res.json(); })];
                    case 1:
                        data = (_g.sent()).data;
                        novel = {
                            path: novelPath,
                        ...
                        branch_name = { 0: 'Главная страница' };
                        if (data.teams.length) {
                            data.teams.forEach(function (_a) {
                                var name = _a.name, details = _a.details;
                                return (branch_name[(details === null || details === void 0 ? void 0 : details.branch_id) || '0'] = name);
                            });
                        }
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(this.apiSite + novelPath + '/chapters', {
                                headers: (_f = this.user) === null || _f === void 0 ? void 0 : _f.token,
                            }).then(function (res) { return res.json(); })];
                    case 2:
                        chaptersJSON = _g.sent();
                        if (chaptersJSON.data.length) {
                            chapters_1 = [];
                            chaptersJSON.data.forEach(function (chapter) {
                                return chapter.branches.forEach(function (_a) {
                                    ...
                                    return chapters_1.push({
                                        ...
                                        path: novelPath +
                                            ...
                                            '/' +
                                            (branch_id || ''),
                                        releaseTime: (0, dayjs_1.default)(created_at).format('LLL'),
                                        chapterNumber: chapter.index,
                                        page: branch_name[branch_id || '0'] || 'Неизвестный',
                                    });
                                });
                            });
                            if (chapters_1.length && data.teams.length > 1) {
                                //For whatever reason, the chapters overlap with another page.
                                chapters_1.sort(function (chapterA, chapterB) {
                                    if (chapterA.page &&
                                        chapterB.page &&
            ...
            case 'image':
                if ((_b = (_a = element.attrs) === null || _a === void 0 ? void 0 : _a.images) === null || _b === void 0 ? void 0 : _b.length) {
                    element.attrs.images.forEach(function (_a) {
                        var image = _a.image;
                        var file = images.find(function (file) { return file.name == image || file.id == image; });
                        if (file) {
