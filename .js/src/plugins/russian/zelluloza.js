...
var Zelluloza = /** @class */ (function () {
    ...
    Zelluloza.prototype.popularNovels = function (pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function (pageNo, _b) {
            var sort, path, body, loadedCheerio, novels;
            var _this = this;
            var _c, _d;
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        path = ((_d = filters === null || filters === void 0 ? void 0 : filters.genres) === null || _d === void 0 ? void 0 : _d.value)
                            ? "/search/genres/".concat(filters.genres.value, "/?page=").concat(pageNo)
                            : "/top/freebooks/?sort_order=".concat(sort, "&page=").concat(pageNo);
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(this.site + path).then(function (res) { return res.text(); })];
                    case 1:
                        body = _e.sent();
                        loadedCheerio = (0, cheerio_1.load)(body);
                        novels = [];
                        loadedCheerio('section[class="book-card-item"]').each(function (index, element) {
                            novels.push({
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        novel = {
                            ...
                            genres: (_c = (_b = (_a = loadedCheerio('.gnres').text()) === null || _a === void 0 ? void 0 : _a.split) === null || _b === void 0 ? void 0 : _b.call(_a, ': ')) === null || _c === void 0 ? void 0 : _c[1],
